            ...
            <div className="playoff-bracket-view">
                ...
                <div className="west">
                    <div className="west-first-round">
                        ...
                        <p><button>{this.props.teams[4].name}</button><button>{this.props.teams[5].name}</button></p>
                        <p><button>{this.props.teams[6].name}</button><button>{this.props.teams[7].name}</button></p>
                    </div>
                ...
                <div className="east">
                    <div className="east-first-round">
                        ...
                        <p><button>{this.props.teams[12].name}</button><button>{this.props.teams[13].name}</button></p>
                        <p><button>{this.props.teams[14].name}</button><button>{this.props.teams[15].name}</button></p>
                    </div>
